      ...
      <div className="dashboard-focus-band px-6 py-6 sm:px-7 sm:py-7">
        <div className="dashboard-focus-band-inner">
          <div className="relative z-10 text-black">
            <nav className="mb-4 flex items-center gap-1.5 text-xs font-semibold text-black/60">
            ...
            <div className="mb-3 flex flex-wrap items-center gap-2">
              <span className="inline-flex items-center gap-1.5 rounded-full bg-white/12 px-3 py-1.5 text-xs font-semibold text-black/90 backdrop-blur-sm">
            ...
            <div className="flex flex-col gap-5 lg:flex-row lg:items-end lg:justify-between">
              <div className="min-w-0 flex-1">
                ...
                {bucketList.description ? (
                  <p className="mt-2 max-w-2xl text-sm leading-relaxed text-black/80 sm:text-base">
                    {bucketList.description}
                  </p>
                ) : null}
                  ...
                  <div className="min-w-0">
                    <div className="flex shrink-0 items-center gap-3">
                      ...
                      {onInviteMembersClick ? (
                        <button
                          type="button"
                          className="inline-flex cursor-pointer items-center gap-2 rounded-full gradient-border bg-white/12 px-4 py-2 text-sm font-semibold backdrop-blur-sm transition hover:bg-white/18 focus:outline-none focus:ring-2 focus:ring-white/70"
