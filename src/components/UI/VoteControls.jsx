...
function VoteControls({
  ...
  // ✅ KEEP THIS — frozen still disables interaction
  ...
  if (isFocus) {
    return (
      <div
        className={`relative overflow-hidden inline-flex w-full sm:max-w-[320px] justify-between items-center gap-2 rounded-[1.4rem] gradient-border px-2.5 py-2 shadow ${className}`}
      >
